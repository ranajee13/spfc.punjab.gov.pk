    ...
    ! function(a) {
        ...
        function R(a, b, c) {
            ...
            var k = {
                ...
                error: function(b, c) {
                    var d = a.oApi._fnLog;
                    "parsererror" == c ? d(a, 0, "Invalid JSON response", 1) : 4 === b.readyState && d(a, 0, "Ajax error", 7), oa(a, !1)
                }
            };
        ...
        function Ia(a) {
            ...
            if (a.oFeatures.bStateSave) {
                ...
                if (f && f.time) {
                    var g = Pa(a, "aoStateLoadParams", "stateLoadParams", [a, f]);
                    if (-1 === d.inArray(!1, g)) {
                        ...
                        if (!(h > 0 && f.time < +new Date - 1e3 * h) && e.length === f.columns.length) {
                            for (a.oLoadedState = d.extend(!0, {}, f), a._iDisplayStart = f.start, a.iInitDisplayStart = f.start, a._iDisplayLength = f.length, a.aaSorting = [], d.each(f.order, function(b, c) {
                                ...
                                }), d.extend(a.oPreviousSearch, da(f.search)), b = 0, c = f.columns.length; c > b; b++) {
                                var i = f.columns[b];
                                e[b].bVisible = i.visible, d.extend(a.aoPreSearchCols[b], da(i.search))
                            }
                            Pa(a, "aoStateLoaded", "stateLoaded", [a, f])
                        }
                    }
                }
            }
        ...
        Wa = function(a) {
            ...
            return this.each(function() {
                ...
                y.push(C), C.oInstance = 1 === b.length ? b : x.dataTable(), h(p), p.oLanguage && g(p.oLanguage), p.aLengthMenu && !p.iDisplayLength && (p.iDisplayLength = d.isArray(p.aLengthMenu[0]) ? p.aLengthMenu[0][0] : p.aLengthMenu[0]), p = Ma(d.extend(!0, {}, w), p), La(C.oFeatures, p, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]), La(C, p, ["asStripeClasses", "ajax", "fnServerData", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "sAjaxSource", "sAjaxDataProp", "iStateDuration", "sDom", "bSortCellsTop", "iTabIndex", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", ["iCookieDuration", "iStateDuration"],
                ...
                var G = C.asStripeClasses,
                    I = d("tbody tr", this).eq(0); - 1 !== d.inArray(!0, d.map(G, function(a) {
                    return I.hasClass(a)
        ...
        Ya = function(a, b) {
            ...
            lastIndexOf: zb.lastIndexOf || function() {
        ...
        }), $a("columns().header()", "column().header()", function() {
            return this.iterator("column", function(a, b) {
                return a.aoColumns[b].nTh
            }, 1)
        }), $a("columns().footer()", "column().footer()", function() {
            return this.iterator("column", function(a, b) {
        ...
        Za("cells()", function(a, b, e) {
                ...
                for (var b, c, d = Wa.version.split("."), e = a.split("."), f = 0, g = e.length; g > f; f++)
                    if (b = parseInt(d[f], 10) || 0,
                        c = parseInt(e[f], 10) || 0, b !== c) return b > c;
                return !0
            ...
            }), Wa.version = "1.10.5", Wa.settings = [], Wa.models = {}, Wa.models.oSearch = {
                bCaseInsensitive: !0,
                sSearch: "",
                bRegex: !1,
                bSmart: !0
        ...
        d.extend(Ub, {
            ...
            var b = Date.parse(a);
            return null !== b && !isNaN(b) || gb(a) ? "date" : null
        }, function(a, b) {
            var c = b.oLanguage.sDecimal;
...
function() {
    var a = function(a, b) {
        ...
        }), b.ext.renderer.pageButton.bootstrap = function(c, d, e, f, g, h) {
            var i, j, k = new b.Api(c),
                l = c.oClasses,
                m = c.oLanguage.oPaginate,
                n = function(b, d) {
                    var f, o, p, q, r = function(b) {
                        b.preventDefault(), a(b.currentTarget).hasClass("disabled") || k.page(b.data.action).draw(!1)
                    };
                    for (f = 0, o = d.length; o > f; f++)
                        if (q = d[f], a.isArray(q)) n(b, q);
                        else {
                            switch (i = "", j = "", q) {
                                case "ellipsis":
                                    i = "&hellip;", j = "disabled";
                            ...
                            i && (p = a("<li>", {
                                ...
                                tabindex: c.iTabIndex,
                                id: 0 === e && "string" == typeof q ? c.sTableId + "_" + q : null
                            }).append(a("<a>", {
                                href: "#"
                            }).html(i)).appendTo(b), c.oApi._fnBindAction(p, {
                                action: q
                            }, r))
                        }
                };
            n(a(d).empty().html('<ul class="pagination"/>').children("ul"), f)
        }, b.TableTools && (a.extend(!0, b.TableTools.classes, {
        ...
        }), a.extend(!0, b.TableTools.DEFAULTS.oTags, {
            collection: {
                container: "ul",
                button: "li",
                liner: "a"
